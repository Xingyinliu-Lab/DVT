...
import sys
import pandas as pd
# python s7_batch_group.py /data/warehouse/ metadata.csv 48 0 1.6
...
def cal_cl(cl):
    for idindex in cl:
        cmdstr='python s2.1_group_interaction.py '+fileplace+' '+metadata_name+' '+str(idindex)+' '+predix+' '+scaling
        print(cmdstr)
        os.system(cmdstr)
    return None
#
